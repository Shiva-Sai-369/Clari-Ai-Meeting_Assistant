      ...
      <section className="pt-32 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-5xl text-center relative z-10">
          <div className="inline-block mb-6 px-4 py-2 rounded-full glass-card">
            <span className="text-sm font-medium gradient-text">Powered by GPT-4o + Whisper</span>
          </div>
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            EchoMeet captures discussions, summarizes them, and transforms them into actionable insights — instantly.
          </p>
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl md:text-5xl font-bold text-center mb-16">
            How <span className="gradient-text">EchoMeet</span> Works
          </h2>
            ...
            {[
              {
                icon: Mic,
                title: "Listen",
                description: "Real-time transcription captures every word with speaker recognition and voice activity detection.",
              },
              {
                icon: Brain,
                title: "Understand",
                description: "AI-powered summaries extract key points, action items, and sentiment from your discussions.",
              },
              {
                icon: Rocket,
                title: "Deliver",
                description: "Send insights directly to Slack, Jira, Trello, or sync with your calendar automatically.",
              },
            ].map((step, index) => (
              <div
                key={index}
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-4xl">
          <div className="glass-card p-12 rounded-3xl text-center glow-effect">
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              Let Your Meetings <span className="gradient-text">Work for You</span>
            </h2>
            <p className="text-xl text-muted-foreground mb-8">
              Join teams who save hours every week with AI-powered meeting assistance
            </p>
            <Link to="/features">
              <Button size="lg" className="bg-gradient-primary hover:opacity-90 transition-opacity glow-effect">
